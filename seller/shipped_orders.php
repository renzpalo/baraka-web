              ...
              <div class="col-sm-12">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    $query = "SELECT orders.* FROM tbl_orders orders, tbl_order_products order_products WHERE orders.order_status = 'shipped' AND orders.order_id = order_products.order_id AND order_products.seller_id = '$sellerId' GROUP BY order_products.order_id";
