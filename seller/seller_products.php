	...
	<div class="row">
		...
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <a href="removed_products.php" class="btn btn-outline-secondary btn-sm">Removed Products</a>
          </div>
          <div class="row">
            <div class="col-sm-12">
              <table class="table">
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_assoc($selectProducts)) {
                    ...
                    echo "<tr>
                            ...
                            <td>
                              <a href='edit_product.php?prod_id=$prodId' class='btn btn-info btn-sm'><i class='fa fa-fw fa-edit'></i></a>
