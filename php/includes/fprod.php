      ...
      <div class="carousel-item col-md-2">
        <div class="card product-card">
          <a href="product_info.php">
            <img class="card-img-top img-fluid" src="images/products/rambutan.jpg" alt="Card image cap">
          </a>
          <div class="card-body">
            <a href="#"><h6 class="card-title prod-name">Product</h6></a>
            <p class="card-text prod-price">Product Price</p>
            <p class="card-text prod-desc">Product Description</p>
          </div>
        </div>
      </div>
