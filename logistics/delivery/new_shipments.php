		...
		switch ($shipStatusOption) {
			case 'tbd':
				...
				if ($updateOrderStatus) {
		            $orderUpdateInfo = "Your package will be delivered today. Our delivery team will contact you upon delivery.";
