			...
			<form action="" method="post">
				...
				<table class="table">
					...
					<tbody>
						...
						$query = "SELECT shippings.*, address.* FROM tbl_shippings shippings, tbl_user_address address WHERE shippings.ad_id = address.ad_id AND shipping_status = 'unreachable' AND  shipping_company = '$logCompany' ORDER BY address.ad_province ASC";
