	...
	<div class="row">
		...
		<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
			<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
				<h1 class="h2">Shipped Shipments</h1>
			...
			<form action="" method="post">
				...
				<table class="table">
					...
					<tbody>
						...
						$query = "SELECT shippings.*, address.* FROM tbl_shippings shippings, tbl_user_address address WHERE shippings.ad_id = address.ad_id AND shipping_status = 'shipped' AND  shipping_company = '$logCompany' ORDER BY address.ad_province ASC";
